function toggleMenu() {
	...
	},
	{
		...
		"inputs": [
			...
			},
			{
				"indexed": false,
				"internalType": "uint256",
				"name": "newRecurringFee",
				"type": "uint256"
			}
		],
		"name": "AirdropClaimFeeUpdated",
		"type": "event"
	},
	{
		"anonymous": false,
		...
		"inputs": [
			{
				"indexed": false,
				"internalType": "uint256",
				"name": "newToEnrollAmount",
				"type": "uint256"
			},
			{
				"indexed": false,
				"internalType": "uint256",
				"name": "newRecurringAmount",
				"type": "uint256"
			},
			{
				"indexed": false,
	...
	},
	{
		...
		"name": "referralAccumulatedAirdrop",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
	...
	{
		"inputs": [],
		"name": "referralRewardwithdrawalFee",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
...
if(!walletConnected)
{
	...
	try{
		...
		if(!Enroll)
		{
			weiAmount = web3.utils.toWei('0.0087', 'ether');
		}
		else
		{
			weiAmount = web3.utils.toWei('0.0044', 'ether');
		}
		const gas = 5000000;
		const result = await contract.methods.claimAirdrop("0x5B38Da6a701c568545dCfcB03FcB875f56beddC4"
).send({from: userAddress, value: weiAmount, gas});
...
document.getElementById('Metamask-button').addEventListener('click', async () => {
      try {
        // Requesting the user's permission to add the token
        ...
        alert('Error adding token to Metamask. Please add it manually.');
      }
    });